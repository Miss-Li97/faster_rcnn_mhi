...
class _fasterRCNN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic):
        ...
        # define rpn
        self.RCNN_rpn = _RPN(self.dout_base_model)#1024
    ...
    def forward(self,im_data, im_info, gt_boxes, num_boxes,MHI_feat):
       ...
       # print(im_data.shape)
        ...
        # MHI_data=MHI_data.to("cuda")

        # from model.faster_rcnn.resnet import mhi_ResNet18
        # net=mhi_ResNet18()
        # net = net.cuda()
        # net.train()
        ...
        rois, rpn_loss_cls, rpn_loss_bbox = self.RCNN_rpn(base_feat, im_info, gt_boxes, num_boxes)#base_feat=[512,1024,3,3]
